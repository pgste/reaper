...
| 08 | [Engine Performance to SLA](08-engine-performance-to-sla.md) | P1 | →READY | Synth #10; Perf P1-1/P1-2/P2-*/P3-* | M–L | — |
| 09 | [GitOps / Policy-as-Code](09-gitops-policy-as-code.md) | P1 | →CONDITIONAL/READY | Prod F2/F3; Sec P1-3 | S (wire) + M (reshape) | 01 (git creds behind auth) |
| 10 | [Environments & Promotion](10-environments-and-promotion.md) | P1 | →READY | Prod F4 | M | 01, 02 (approval actor + verified promote) |
