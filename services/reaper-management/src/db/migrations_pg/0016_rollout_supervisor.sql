...
ALTER TABLE rollback_configs ADD COLUMN IF NOT EXISTS mode TEXT NOT NULL DEFAULT 'monitor';
ALTER TABLE rollouts ADD COLUMN IF NOT EXISTS triggered_by TEXT;
