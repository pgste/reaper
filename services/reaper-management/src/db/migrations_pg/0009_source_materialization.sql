...
ALTER TABLE bundles ADD COLUMN IF NOT EXISTS source_id TEXT REFERENCES policy_sources(id) ON DELETE SET NULL;
ALTER TABLE bundles ADD COLUMN IF NOT EXISTS source_commit TEXT;
